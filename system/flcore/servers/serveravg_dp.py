...
# flcore/servers/serveravg_dp.py
from flcore.clients.clientavg_dp import clientAVG_DP
...
class FedAvg_DP(ServerDPBase):
    def __init__(self, args, times):
        ...
        # Configurações específicas do FedAvg
        self.set_slow_clients()
        self.set_clients(clientAVG_DP)
    ...
    # IMPORTANTE: Não implementamos o método train() aqui.
    # O Python usará automaticamente o train() otimizado e corrigido 
    # que está na classe pai (ServerDPBase).
